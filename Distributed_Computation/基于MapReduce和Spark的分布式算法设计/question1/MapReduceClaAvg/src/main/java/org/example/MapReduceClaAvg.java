...
public class MapReduceClaAvg {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, org.example.MapReduceClaAvg.class.getSimpleName());
        //打成jar执行
        job.setJarByClass(org.example.MapReduceClaAvg.class);
